...
//export class PushArray<T> extends Array<T>{
//    push(...items: T[]):number {
...
var memberDecorator = (function () {
    function memberDecorator() {
        ...
        this.befores = [];
        this.afters = []; //PushArray<ITrigger> = new PushArray<ITrigger>();// 
        this.checks = [];
        this.onGets = [];
        this.validates = [];
        this.bindBefores = [];
        ...
        this.defaultValue = function (value) {
            _this.defaultPropertyValue = value;
            return _this;
        };
        this.listeners = {};
        ...
        this.instantiate = function () {
            switch (_this.type) {
                ...
                case 'method':
                    ...
                    break;
                case 'readonly':
                    _this.readonly(_this.target, _this.propertyKey);
                    break;
            }
        ...
        this.readonly = function (target, propertyKey, descriptor) {
            //need to read the getter from the descriptor and then set it to any new instance;
            if (obs.disabled)
                return;
            _this.replaceSelf(target, propertyKey);
            obs.setDecorator(target, propertyKey, _this).initializeReadonly(target, propertyKey, descriptor);
        };
        this.initializeReadonly = function (target, propertyKey, descriptor) {
            var that = _this;
            _this.initialize();
            _this.type = 'readonly';
            if (descriptor) {
                //when there is descriptor, it is initializing the prototype and the getter from the original descriptor should be kept.
                descriptor.configurable = true;
                descriptor.enumerable = false;
                _this.getter = descriptor.get;
            }
            else {
                //when there is no descriptor, it is initializing the instance and the getter should be assigned to the object;
        ...
        this.initializeProperty = function (target, propertyKey, descriptor) {
            ...
            if (_this.defaultPropertyValue !== undefined)
                _this.RealValue = _this.defaultPropertyValue;
            if (descriptor) {
                descriptor.configurable = true;
        ...
        this.initializeEvent = function (target, propertyKey, descriptor) {
            ...
            var invoker = function (source, memberKey, decorators) {
                var args = [];
                for (var _i = 3; _i < arguments.length; _i++) {
                    args[_i - 3] = arguments[_i];
                }
            ...
            _this.invoker = function () {
                ...
                var invokingArgs = [undefined, undefined, []];
                Array.prototype.push.apply(invokingArgs, args);
                return invoker.apply(undefined, invokingArgs);
            };
            _this.checker = function (source, memberKey, decorators) {
                var args = [];
                for (var _i = 3; _i < arguments.length; _i++) {
        ...
        this.allocate = function (newDecorator) {
            ...
            if (newDecorator.defaultPropertyValue !== undefined)
                _this.defaultPropertyValue = newDecorator.defaultPropertyValue;
        };
    ...
    memberDecorator.prototype.clone = function (instance) {
        ...
        d.defaultPropertyValue = this.defaultPropertyValue;
    ...
    memberDecorator.prototype.overwrite = function (d) {
        ...
        if (this.observableType)
            d.observableType = this.observableType;
        if (this.defaultPropertyValue !== undefined)
            d.defaultPropertyValue = this.defaultPropertyValue;
        d.type = this.type;
        return d;
    };
    ...
    memberDecorator.prototype.applyDecorator = function (d) {
        ...
        if (d.defaultPropertyValue !== undefined)
            this.defaultPropertyValue = d.defaultPropertyValue;
...
var objectDecorator = (function () {
    function objectDecorator() {
        var _this = this;
        this.in = function (modulePath) {
            _this.modulePath = modulePath;
            return _this;
        };
        /**
        ...
        this.bindableBase = function (target, instanceFunction) {
            ...
            function construct(args) {
                ...
                if (that['@ObjectService.ConstructionStack'].length == 1) {
                    ...
                    if (obd.isReferenceType) {
                        Object.defineProperty(that, '@ObjectService.Reference', {
                            configurable: false,
                            enumerable: true,
                            value: true,
                            writable: false
        ...
        this.observable = function (target) {
            var arrayChangeHandler = {
                deleteProperty: function (obsArray, property) {
                    ...
                    //console.trace('inOverwrittenOperation mode:', obsArray.inOverwrittenOperation);
                    if (obsArray.inOverwrittenOperation)
                        return true; //do not raise event in case of internal operation;
    ...
    Object.defineProperty(objectDecorator.prototype, "ref", {
        /**specify that the decorated type is serialized as reference*/
        get: function () {
    ...
    objectDecorator.setupBindable = function (that, classPrototype) {
        //if (that['@ObjectService.ConstructionStack'].length == 1) {
        //console.log('*** dcrs After Call Original: ', original.name, obp.getPathValue(that, p), obp.getPathValue(classPrototype, p),
        //    obp.getPathValue(that, pp), obp.getPathValue(classPrototype, pp));
        var prototypeDecorators = classPrototype['@ObjectService.Decorators'];
...
var obs = (function () {
    ...
    obs.enableBindable = function (instance, classPrototype) {
        objectDecorator.setupBindable(instance, classPrototype);
    };
    /**
     * this is the repalcer for serializing bindable objects;
     * @param key
     * @param value
     */
    obs.stringifyReplacer = function (key, value) {
        //console.log('replacer: ', key, value);
        if (value['@ObjectService.ModulePath'] && value['@ObjectService.TypeName']) {
            var replaced = {};
            for (var key_1 in value) {
                switch (key_1) {
                    case '@ObjectService.Prototype':
                    case '@ObjectService.Decorators':
                        break;
                    case '@ObjectService.ModulePath':
                        replaced['@Serializable.ModuleName'] = value[key_1];
                        break;
                    case '@ObjectService.TypeName':
                        replaced['@Serializable.TypeName'] = value[key_1];
                        break;
                    default:
                        var d = obs.getDecorator(value, key_1, true);
                        if (d) {
                        }
                        else {
                            replaced[key_1] = value[key_1];
                        }
                        break;
                }
            }
            var decorators = value['@ObjectService.Decorators'];
            for (var key_2 in decorators) {
                var d = decorators[key_2];
                if (d.type == 'property' && replaced[key_2] === undefined) {
                    replaced[key_2] = d.RealValue;
                }
            }
            return replaced;
        }
    ...
    obs.parseReviver = function (key, value) {
        ...
        if (value['@Serializable.ModuleName'] && value['@Serializable.TypeName']) {
            ...
            //let _module = require(value['@Serializable.ModuleName']);
            System.import(value['@Serializable.ModuleName']).then(function (_mod) {
                var _constructor = _mod[value['@Serializable.TypeName']];
                var replaced = new (Function.prototype.bind.apply(_constructor, []));
                for (var key_3 in value) {
                    switch (key_3) {
                        case '@Serializable.ModuleName':
                        case '@Serializable.TypeName':
                            break;
                        default:
                            replaced[key_3] = value[key_3];
                            break;
                    }
                }
    ...
    obs.defaultValue = function (value) {
        return (new memberDecorator()).defaultValue(value);
    };
    ...
    obs.appendMethodAfter = function (target, member, host, method) {
        var memberName = obp.analyzeMember(member);
        var decorator = obs.getDecorator(target, memberName, true);
        var trigger = { target: host, method: function (source, key, decorators) {
                var args = [];
                for (var _i = 3; _i < arguments.length; _i++) {
                    args[_i - 3] = arguments[_i];
                }
    ...
    obs.appendMethodBefore = function (target, member, host, method) {
        var memberName = obp.analyzeMember(member);
        var decorator = obs.getDecorator(target, memberName, true);
        var trigger = { target: host, method: function (source, key, decorators) {
                var args = [];
    ...
    obs.in = function (modulePath) {
        return (new objectDecorator).in(modulePath);
    };
    Object.defineProperty(obs, "ref", {
        get: function () {
            return (new objectDecorator).ref;
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(obs, "readonly", {
        get: function () {
            return (new memberDecorator()).readonly;
        },
        enumerable: true,
        configurable: true
    });
    ...
    obs.setDecorator = function (value, propertyKey, decorator) {
        ...
        if (decorators[propertyKey]) {
            ...
            if (decorators[propertyKey] != decorator)
            ...
            return __generator(this, function (_v) {
                switch (_v.label) {
                    case 0:
                        ...
                        if (!jsonObject['@ObjectService.ObservableArray']) return [3 /*break*/, 6];
                        arr = new ObservableArray();
                        length_1 = jsonObject.length;
                        i = 0;
                        _v.label = 1;
                    case 1:
                        if (!(i < length_1)) return [3 /*break*/, 5];
                        _b = (_a = arr).push;
                        return [4 /*yield*/, obs.deserialize(jsonObject[i])];
                    case 2: return [4 /*yield*/, _b.apply(_a, [_v.sent()])];
                    case 3:
                        _v.sent();
                        _v.label = 4;
                    case 4:
                    ...
                    case 6:
                        if (jsonObject['@ObjectService.GlobalType']) {
                            //console.log('Global Type: ', jsonObject);
                            switch (jsonObject['@ObjectService.GlobalType']) {
                                case 'RegExp':
                                    return [2 /*return*/, new RegExp(jsonObject['source'], jsonObject['flags'])];
                                case 'Date':
                                    return [2 /*return*/, new Date(jsonObject['value'])];
                            }
                        }
                        if (!(jsonObject['@ObjectService.ModulePath'] && jsonObject['@ObjectService.TypeName'])) return [3 /*break*/, 22];
                        moduleName = jsonObject['@ObjectService.ModulePath'];
                    ...
                    case 8:
                        ...
                        property = _d[_i];
                        if (!!/^@ObjectService\./.test(property)) return [3 /*break*/, 16];
                        if (!(instance[property] && instance[property]['@ObjectService.ObservableArray'] && Array.isArray(jsonObject[property]))) return [3 /*break*/, 13];
                        arr = (jsonObject[property]);
                        obsArr = instance[property];
                        i = 0;
                        _v.label = 9;
                    case 9:
                        if (!(i < arr.length)) return [3 /*break*/, 12];
                        _g = (_f = obsArr).push;
                        return [4 /*yield*/, obs.deserialize(arr[i])];
                    case 10:
                        _g.apply(_f, [_v.sent()]);
                        _v.label = 11;
                    case 11:
                    ...
                    case 13:
                        ...
                        _j = instance;
                        _k = property;
                        return [4 /*yield*/, obs.deserialize(jsonObject[property])];
                    case 14:
                        _j[_k] = _v.sent();
                        return [3 /*break*/, 16];
                    case 15:
                        ...
                        if (descriptor) {
                            ...
                            console.log('get: ', descriptor.get ? true : false);
                            console.log('set: ', descriptor.set ? true : false);
                        }
                        console.error('error at property: ', property, ex_1);
                        return [3 /*break*/, 16];
                    case 16:
                        if (!Array.isArray(jsonObject)) return [3 /*break*/, 20];
                        i = 0;
                        _v.label = 17;
                    case 17:
                        if (!(i < jsonObject.length)) return [3 /*break*/, 20];
                        _l = instance;
                        _m = i;
                        return [4 /*yield*/, obs.deserialize(jsonObject[i])];
                    case 18:
                    ...
                    case 20:
                        _i++;
                        return [3 /*break*/, 8];
                    case 21: return [2 /*return*/, instance];
                    case 22:
                        if (!Array.isArray(jsonObject)) return [3 /*break*/, 27];
                        instance = [];
                        i = 0;
                        _v.label = 23;
                    case 23:
                        if (!(i < jsonObject.length)) return [3 /*break*/, 26];
                        _o = instance;
                        _p = i;
                        return [4 /*yield*/, obs.deserialize(jsonObject[i])];
                    case 24:
                    ...
                    case 25:
                        i++;
                        return [3 /*break*/, 23];
                    case 26: return [2 /*return*/, instance];
                    case 27:
                        instance = {};
                        _q = [];
                        for (_r in jsonObject)
                            _q.push(_r);
                        _s = 0;
                        _v.label = 28;
                    case 28:
                        if (!(_s < _q.length)) return [3 /*break*/, 31];
                        key = _q[_s];
                        _t = instance;
                        _u = key;
                        return [4 /*yield*/, obs.deserialize(jsonObject[key])];
                    case 29:
                        _t[_u] = _v.sent();
                        _v.label = 30;
                    case 30:
                        _s++;
                        return [3 /*break*/, 28];
                    case 31: return [2 /*return*/, instance];
                }
            });
        });
    };
    obs.serializationReplacer = function (key, value) {
        //console.log('replacer: ', key, value);
        if (!value)
            return value;
        if (value['@ObjectService.ObservableArray']) {
            var arr = value.map(function (item) { return item; });
            arr['@ObjectService.ObservableArray'] = true;
            //console.log( '@ObjectService.ObservableArray: ', arr);
            return arr;
        }
        if (value['@ObjectService.ModulePath'] && value['@ObjectService.TypeName']) {
            var replaced = {};
            for (var key_4 in value) {
                switch (key_4) {
                    case '@ObjectService.Prototype':
                    case '@ObjectService.Decorators':
                        break;
                    case '@ObjectService.ModulePath':
                        replaced['@ObjectService.ModulePath'] = value[key_4];
                        break;
                    case '@ObjectService.TypeName':
                        replaced['@ObjectService.TypeName'] = value[key_4];
                        break;
                    default:
                        var d = obs.getDecorator(value, key_4, true);
                        if (d) {
                        }
                        else {
                            replaced[key_4] = value[key_4];
                        }
                        break;
                }
            }
            var decorators = value['@ObjectService.Decorators'];
            for (var key_5 in decorators) {
                var d = decorators[key_5];
                if (d.type == 'property' && replaced[key_5] === undefined) {
                    replaced[key_5] = d.RealValue;
                }
            }
            return replaced;
        }
        if (value instanceof RegExp) {
            //console.log('RegExp', key, '->', value);
            return {
                '@ObjectService.GlobalType': 'RegExp',
                'flags': value.flags,
                'source': value.source
            };
        }
        if (value instanceof Date) {
            ...
            return {
                '@ObjectService.GlobalType': 'Date',
                'value': Number(value)
            };
        }
        return value;
    };
    obs.serialize = function (data) {
        return JSON.stringify(data, obs.serializationReplacer);
    };
    /**
     * pack object with by reference feature;
     * @param data
     */
    obs.pack = function (data) {
        var dict = [];
        function referenceReplacer(value) {
            if (!value)
                return value;
            if (typeof value != 'object')
                return value;
            if (value['@ObjectService.Reference']) {
                for (var index_1 = 0; index_1 < dict.length; index_1++) {
                    if (dict[index_1] == value)
                        return { '@ObjectService.Pointer': index_1 };
                }
                dict.push(value);
                return { '@ObjectService.Pointer': dict.length - 1 };
            }
            return value;
        }
        function objectReplacer(key, value) {
            ...
            if (!value)
                return value;
            if (key != '' && value['@ObjectService.Reference']) {
                return referenceReplacer(value);
            }
            if (value['@ObjectService.ObservableArray']) {
                var arr_1 = value.map(function (item) { return item; });
                arr_1['@ObjectService.ObservableArray'] = true;
                //console.log( '@ObjectService.ObservableArray: ', arr);
                return arr_1;
            }
            if (value['@ObjectService.ModulePath'] && value['@ObjectService.TypeName']) {
                ...
                for (var field in value) {
                    switch (field) {
                        case '@ObjectService.Prototype':
                        case '@ObjectService.Decorators':
                        case '@ObjectService.Reference':
                            break;
                        case '@ObjectService.ModulePath':
                            replaced['@ObjectService.ModulePath'] = value[field];
                            break;
                        case '@ObjectService.TypeName':
                            replaced['@ObjectService.TypeName'] = value[field];
                            break;
                        default:
                            var d = obs.getDecorator(value, field, true);
                            if (d) {
                            }
                            else {
                                replaced[field] = value[field];
                            }
                            break;
                    }
                }
                var decorators = value['@ObjectService.Decorators'];
                for (var key_6 in decorators) {
                    var d = decorators[key_6];
                    if (d.type == 'property' && replaced[key_6] === undefined) {
                        replaced[key_6] = d.RealValue;
                    }
                }
                return replaced;
            }
        ...
        //add the root object to the dict;
        dict.push(data);
        var arr = [];
        var index = 0;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!Array.isArray(arr))
                            return [2 /*return*/];
                        unpacker = new Unpacker(arr);
                        return [4 /*yield*/, unpacker.unpack()];
...
exports.obs = obs;
/**
 * this is a class that deserialize the pack objects
 */
var Unpacker = (function () {
    function Unpacker(dict) {
        this.dict = dict;
        this.instances = {};
    }
    Unpacker.prototype.unpack = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getInstance(0)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Unpacker.prototype.getInstance = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var obj;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.instances[key])
                            return [2 /*return*/, this.instances[key]];
                        if (!this.dict[key])
                            return [2 /*return*/, undefined];
                        obj = JSON.parse(this.dict[key]);
                        return [4 /*yield*/, this.deserialize(obj, key)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
                ...
                switch (_v.label) {
                    case 0:
                        ...
                        if (typeof jsonObject != 'object')
                            return [2 /*return*/, jsonObject];
                        if (!jsonObject['@ObjectService.ObservableArray']) return [3 /*break*/, 6];
                        instance = new ObservableArray();
                        if (typeof key == 'number')
                            this.instances[key] = instance; //assign instance for async process;
                        length_2 = jsonObject.length;
                        i = 0;
                        _v.label = 1;
                    case 1:
                        if (!(i < length_2)) return [3 /*break*/, 5];
                        _b = (_a = instance).push;
                        return [4 /*yield*/, this.deserialize(jsonObject[i])];
                    case 2: return [4 /*yield*/, _b.apply(_a, [_v.sent()])];
                    case 3:
                        _v.sent();
                        _v.label = 4;
                    ...
                    case 6:
                        ...
                        if (!(typeof jsonObject['@ObjectService.Pointer'] == 'number')) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.getInstance(jsonObject['@ObjectService.Pointer'])];
                    case 7: return [2 /*return*/, _v.sent()];
                    case 8:
                        if (!(jsonObject['@ObjectService.ModulePath'] && jsonObject['@ObjectService.TypeName'])) return [3 /*break*/, 24];
                        moduleName = jsonObject['@ObjectService.ModulePath'];
                        typeName = jsonObject['@ObjectService.TypeName'];
                        return [4 /*yield*/, System.import(moduleName)];
                    case 9:
                    ...
                    case 10:
                        ...
                        property = _d[_i];
                        if (!!/^@ObjectService\./.test(property)) return [3 /*break*/, 18];
                        if (!(instance[property] && instance[property]['@ObjectService.ObservableArray'] && Array.isArray(jsonObject[property]))) return [3 /*break*/, 15];
                        arr = (jsonObject[property]);
                        obsArr = instance[property];
                        i = 0;
                        _v.label = 11;
                    case 11:
                        if (!(i < arr.length)) return [3 /*break*/, 14];
                        _g = (_f = obsArr).push;
                        return [4 /*yield*/, obs.deserialize(arr[i])];
                    case 12:
                        _g.apply(_f, [_v.sent()]);
                    ...
                    case 15:
                        ...
                        _j = instance;
                        _k = property;
                        return [4 /*yield*/, this.deserialize(jsonObject[property])];
                    case 16:
                        //console.log('deserialize property: ', property);
                        _j[_k] = _v.sent();
                        return [3 /*break*/, 18];
                    case 17:
                        ...
                        console.error('error at property: ', property, ex_2);
                        return [3 /*break*/, 18];
                    case 18:
                        if (!Array.isArray(jsonObject)) return [3 /*break*/, 22];
                        i = 0;
                        _v.label = 19;
                    case 19:
                        if (!(i < jsonObject.length)) return [3 /*break*/, 22];
                        _l = instance;
                        _m = i;
                        return [4 /*yield*/, this.deserialize(jsonObject[i])];
                    case 20:
                    ...
                    case 22:
                        _i++;
                        return [3 /*break*/, 10];
                    case 23: return [2 /*return*/, instance];
                    case 24:
                        if (!Array.isArray(jsonObject)) return [3 /*break*/, 29];
                        instance = [];
                        if (typeof key == 'number')
                            this.instances[key] = instance; //assign instance for async process;
                        i = 0;
                        _v.label = 25;
                    case 25:
                        if (!(i < jsonObject.length)) return [3 /*break*/, 28];
                        _o = instance;
                        _p = i;
                        return [4 /*yield*/, this.deserialize(jsonObject[i])];
                    case 26:
                    ...
                    case 27:
                        i++;
                        return [3 /*break*/, 25];
                    case 28: return [2 /*return*/, instance];
                    case 29:
                        instance = {};
                        if (typeof key == 'number')
                            this.instances[key] = instance; //assign instance for async process;
                        ...
                        _v.label = 30;
                    case 30:
                        if (!(_s < _q.length)) return [3 /*break*/, 33];
                        key_7 = _q[_s];
                        _t = instance;
                        _u = key_7;
                        return [4 /*yield*/, this.deserialize(jsonObject[key_7])];
                    case 31:
                        _t[_u] = _v.sent();
                        _v.label = 32;
                    case 32:
                        _s++;
                        return [3 /*break*/, 30];
                    case 33: return [2 /*return*/, instance];
                }
            });
        });
    };
...
})(PathBindingMode = exports.PathBindingMode || (exports.PathBindingMode = {}));
var ArrExt = (function () {
    function ArrExt() {
    }
...
var ObservableArray = ObservableArray_1 = (function (_super) {
    ...
    function ObservableArray() {
        ...
        _this.inOverwrittenOperation = false;
        _this.childDefaultChanged = function (source, key, decorators, newValue, oldValue) {
        ...
        _this.childrenListenPaths = [];
        _this.itemListeners = [];
        _this.itemEvents = (new EventProxy());
        Object.defineProperty(_this, '@ObjectService.ObservableArray', {
            configurable: false,
            enumerable: true,
            value: true,
            writable: false
        ...
        Array.prototype.push.apply(_this.itemListeners, items.map(function (item) { return new itemListener(_this, item, _this.childrenListenPaths); }));
        return _this;
    }
    ObservableArray.prototype.push = function () {
        ...
        this.inOverwrittenOperation = true;
        var r = Array.prototype.push.apply(this, items);
        this.inOverwrittenOperation = false;
...
__decorate([
    obs.after(function () { return ObservableArray_1.prototype.populate; }).event,
...
__decorate([
    obs.after(function () { return ObservableArray_1.prototype.childDefaultChanged; }).property,
...
__decorate([
    obs.after(function () { return ObservableArray_1.prototype.observationSourceChanged; }).property,
...
__decorate([
    obs.after(function () { return ObservableArray_1.prototype.populate; }).property,
    __metadata("design:type", Function)
...
__decorate([
    obs.after(function () { return ObservableArray_1.prototype.populationTargetChanged; }).property,
    __metadata("design:type", Array)
...
__decorate([
    obs.after(function () { return ObservableArray_1.prototype.observe; }).property,
    __metadata("design:type", Function)
...
ObservableArray = ObservableArray_1 = __decorate([
    obs.bindable,
...
(function (ArrayOperationType) {
    ArrayOperationType[ArrayOperationType["null"] = 0] = "null";
    ArrayOperationType[ArrayOperationType["reset"] = 1] = "reset";
    ArrayOperationType[ArrayOperationType["replace"] = 2] = "replace";
    ArrayOperationType[ArrayOperationType["delete"] = 3] = "delete";
    ArrayOperationType[ArrayOperationType["push"] = 4] = "push";
    ArrayOperationType[ArrayOperationType["pop"] = 5] = "pop";
    ArrayOperationType[ArrayOperationType["unshift"] = 6] = "unshift";
    ArrayOperationType[ArrayOperationType["shift"] = 7] = "shift";
    ArrayOperationType[ArrayOperationType["splice"] = 8] = "splice";
    ArrayOperationType[ArrayOperationType["configure"] = 9] = "configure";
})(ArrayOperationType = exports.ArrayOperationType || (exports.ArrayOperationType = {}));
var BindableTest;
(function (BindableTest) {
    var enabled = false;
    if (enabled) {
        var point_1 = point_2 = (function () {
            function point_1() {
        ...
        __decorate([
            obs.after(function () { return point_2.prototype.solo(); }).method,
            __metadata("design:type", Function),
            __metadata("design:paramtypes", []),
            __metadata("design:returntype", void 0)
        ], point_1.prototype, "jam", null);
        point_1 = point_2 = __decorate([
            obs.bindable,
            __metadata("design:paramtypes", [])
        ], point_1);
        ...
        var tester_1 = tester_2 = (function () {
        ...
        __decorate([
            obs.before(function () { return tester_2.prototype.close(); }).event,
            __metadata("design:type", Function),
            __metadata("design:paramtypes", []),
            __metadata("design:returntype", void 0)
        ], tester_1.prototype, "loop", null);
        __decorate([
            obs.after(function () { return tester_2.prototype.chidren.$$invokeEachElementInArray().solo(); }).event,
            __metadata("design:type", Function),
            __metadata("design:paramtypes", []),
            __metadata("design:returntype", String)
        ], tester_1.prototype, "close", null);
        __decorate([
            obs.after(function () { return tester_2.prototype.close(); }).property,
            __metadata("design:type", point_1)
        ], tester_1.prototype, "joke", void 0);
        __decorate([
            obs.bind(function () { return tester_2.prototype.joke.x; }).property,
            __metadata("design:type", String)
        ], tester_1.prototype, "tom", void 0);
        __decorate([
            obs.after(function () { return tester_2.prototype.joke.solo(); }).property,
            __metadata("design:type", String)
        ...
        var a = (function (_super) {
            ...
            function a() {
                var _this = _super.call(this) || this;
                _this.view = document.createElement('a');
                return _this;
            }
            return a;
        }(SyncElement));
        ...
        var svg = (function (_super) {
            ...
            function svg() {
                var _this = _super.call(this) || this;
                _this.view = document.createElement('svg');
                return _this;
            }
            return svg;
        }(SyncElement));
        ...
        var SyncWindow = (function (_super) {
            ...
            function SyncWindow() {
                ...
                _this.children = new ObservableArray();
                return _this;
            }
...
(function (ObservableTest) {
    ...
    if (enabled) {
        ...
        var PopulationTest_1 = PopulationTest_2 = (function () {
        ...
        __decorate([
            obs.default(function () { return ObservableArray.prototype.parent; })
                .observe(function () { return PopulationTest_2.prototype.flowers; }, function () { return PopulationTest_2.prototype.flower2product; })
                .populate(function () { return PopulationTest_2.prototype.view; })
                .property,
            __metadata("design:type", ObservableArray)
        ...
        PopulationTest_1 = PopulationTest_2 = __decorate([
            obs.bindable,
            __metadata("design:paramtypes", [String])
        ], PopulationTest_1);
...
(function (PathChangeTest) {
    ...
    if (enabled) {
        ...
        __decorate([
            obs.default(function () { return ObservableArray.prototype.parent; }).observe(function () { return host_2.prototype.branch.birds; }).property,
            __metadata("design:type", ObservableArray)
        ], host_1.prototype, "catched", void 0);
        host_1 = host_2 = __decorate([
            obs.bindable
        ], host_1);
        var h = new host_1();
...
(function (ListenTest) {
    ...
    if (enabled) {
        ...
        var host_3 = host_4 = (function () {
            function host_3() {
            }
            host_3.prototype.whenJoke = function (x, y) {
        ...
        ], host_3.prototype, "joke", void 0);
        __decorate([
            obs.listen(function () { return host_4.prototype.joke.onmouse; }).event //
            ,
            __metadata("design:type", Function),
            __metadata("design:paramtypes", [Number, Number]),
            __metadata("design:returntype", void 0)
        ], host_3.prototype, "whenJoke", null);
        host_3 = host_4 = __decorate([
            obs.bindable
        ], host_3);
        var h_1 = new host_3();
        var j = new joker();
        ...
        obs.block(h_1, function () { return host_3.prototype.whenJoke; }, function () {
...
(function (inheritTest) {
    ...
    if (enabled) {
        ...
        __decorate([
            obs.listen(function () { return base_2.prototype.seed0.tick; }).event,
            __metadata("design:type", Object)
        ], base_1.prototype, "method", void 0);
        base_1 = base_2 = __decorate([
            obs.bindable
        ], base_1);
        var host_5 = host_6 = (function (_super) {
            __extends(host_5, _super);
            function host_5() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.seed1 = new sender();
                _this.seed2 = new sender();
        ...
        __decorate([
            obs.property,
            __metadata("design:type", sender)
        ], host_5.prototype, "seed1", void 0);
        __decorate([
            obs.property,
            __metadata("design:type", sender)
        ], host_5.prototype, "seed2", void 0);
        __decorate([
            obs.listen(function () { return host_6.prototype.seed1.tick; }, function () { return host_6.prototype.seed2.tick; }).event,
            __metadata("design:type", Object)
        ], host_5.prototype, "method", void 0);
        host_5 = host_6 = __decorate([
            obs.bindable
        ], host_5);
        var sender = (function () {
            function sender() {
...
(function (observeTest) {
    ...
    if (enabled) {
        ...
        __decorate([
            obs.observable(ObservableArray).default(function () { return ObservableArray.prototype.parent; }).observe(function () { return Host_2.prototype.views; }).property,
            __metadata("design:type", ObservableArray)
        ...
        __decorate([
            obs.listen(function () { return Host_2.prototype.children.onchange; }).event,
            __metadata("design:type", Object)
